  ...
  return (
    <header className='pointer-events-none fixed inset-x-0 top-4 z-50 flex justify-center px-3 sm:top-6 sm:px-6'>
      ...
      >
        <Link
          href='/'
          className='brand-type-link rounded-full px-3 py-2 font-mono text-xs font-semibold tracking-widest text-slate-800 uppercase transition hover:text-violet-700 focus-visible:ring-2 focus-visible:ring-violet-400/70 focus-visible:outline-none dark:text-zinc-100 dark:hover:text-violet-200'
          aria-label='Go home'
        >
          ...
          {navLinks.map((link) => {
            ...
            return (
              ...
              >
                ...
                <span
                  className={cn(
                    'absolute inset-x-4 bottom-1 h-px origin-center bg-gradient-to-r from-cyan-400 via-violet-500 to-amber-300 transition duration-200',
                    isActive
