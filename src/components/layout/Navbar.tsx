          ...
          {navLinks.map((link) => {
            ...
            return (
              ...
              >
                ...
                <span
                  className={cn(
                    'absolute inset-x-4 bottom-1 h-px origin-center bg-purple-500 transition duration-200 dark:bg-purple-300',
                    isActive
