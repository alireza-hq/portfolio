...
function fieldClass(hasError: boolean) {
  return cn(
    'contact-form-control peer h-14 w-full rounded-2xl border border-zinc-900/10 bg-zinc-50/90 px-4 pt-5 pb-2 text-zinc-950 transition outline-none placeholder:text-transparent focus:border-sky-400 focus:bg-white dark:border-white/10 dark:bg-white/6 dark:text-white dark:focus:bg-zinc-950',
    hasError &&
...
function textareaClass(hasError: boolean) {
  return cn(
    'contact-form-control peer min-h-40 w-full resize-none rounded-2xl border border-zinc-900/10 bg-zinc-50/90 px-4 pt-7 pb-4 text-zinc-950 transition outline-none placeholder:text-transparent focus:border-sky-400 focus:bg-white dark:border-white/10 dark:bg-white/6 dark:text-white dark:focus:bg-zinc-950',
    hasError &&
      'border-red-400 focus:border-red-400 dark:border-red-400 dark:focus:border-red-400',
  )
}
