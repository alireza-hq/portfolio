...
export const ContactForm = () => {
  ...
  return (
    <form
      className='rounded-4xl border border-zinc-900/10 bg-white/70 p-6 shadow-2xl shadow-zinc-900/8 backdrop-blur-md sm:p-8 lg:p-10 dark:border-white/10 dark:bg-zinc-950/70 dark:shadow-black/25'
