      ...
      <section className='mx-auto w-full max-w-7xl'>
        ...
        <div className='mt-12 grid gap-4 md:grid-cols-3'>
          {projects.map((project) => (
            <article
              key={project.name}
              className='group rounded-3xl border border-slate-900/10 bg-white/55 p-6 shadow-xl shadow-slate-900/5 backdrop-blur-xl transition duration-200 hover:-translate-y-1 hover:border-sky-400/40 dark:border-white/10 dark:bg-white/5 dark:shadow-black/20'
            >
              ...
              <div className='mt-6 inline-flex h-9 w-9 items-center justify-center rounded-full border border-slate-900/10 text-slate-600 transition group-hover:border-sky-400/40 group-hover:text-sky-700 dark:border-white/10 dark:text-zinc-300 dark:group-hover:text-sky-200'>
